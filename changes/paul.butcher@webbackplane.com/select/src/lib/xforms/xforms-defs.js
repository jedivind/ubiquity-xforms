...
DECORATOR.addDecorationRules({
    ...
    "rules" : {
        ...
        "output" : [
        {
            "name" : "output-element",
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([EventTarget, MIPHandler, Context, Control, OptionalIfUnspecifiedBinding]);
            }
        }
        ],
        ...
        "select" : [
        {
            "name" : "select-element",
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([EventTarget, MIPHandler, Context, Control, XFormsCommonSelect,  ElementWithChoices, XFormsSelect, FiniteControl]);
            }
        }
        ],
        ...
        "select1" : [
        {
            ...
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([EventTarget, MIPHandler, Context, Control, XFormsCommonSelect, ElementWithChoices, XFormsSelect1, FiniteControl]);
            }
        }
        ],
