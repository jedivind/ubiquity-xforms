...
DECORATOR.addDecorationRules({
    ...
    "rules" : {
        ...
        "select" : [
        {
            "name" : "select-element",
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([EventTarget, Context, Control, ElementWithChoices, XFormsSelect, FiniteControl]);
            }
        }
        ],
        ...
        "select1" : [
        {
            ...
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([EventTarget, Context, Control, ElementWithChoices, XFormsSelect1, FiniteControl]);
            }
        }
        ],
