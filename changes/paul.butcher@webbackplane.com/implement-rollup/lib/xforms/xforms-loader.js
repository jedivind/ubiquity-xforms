...
(
  function(){
    ...
    g_sBehaviourDirectory = moduleBase + "../../behaviours/";
  	...
  	loader.addModule({ name: "ux-default-css",       type: "css",  fullpath: moduleBase + "../../assets/default.css"});
	...
	loader.addModule({ name: "xforms-hint-css",     type: "css", fullpath: moduleBase + "../../assets/hint.css" });
