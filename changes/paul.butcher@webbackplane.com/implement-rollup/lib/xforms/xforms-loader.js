...
(
  function(){
    var moduleBase = pathToModule("xforms-loader");
  	...
  	var defaultCSS = (typeof UX !== 'undefined' && UX.isXHTML) ? "style/default-xml.css" : "style/default.css";
	var hintCSS = (typeof UX !== 'undefined' && UX.isXHTML) ? "style/hint-xml.css" : "style/hint.css";
    ...
    loader.addModule({ name: "xforms-defs",                type: "js",  fullpath: moduleBase + "xforms-defs.js",
      requires: [
        ...
        "xforms-model", "xforms-instance", "xforms-submission", "xforms-submission-core-yui",
