...
//Now needed to make rollup and modular mode behave similarly.
function IEInsertElementForOnloadXBL(){
    document.body.insertAdjacentHTML("beforeEnd","<p id='second-onload-loading-element'style='width:0px;style:display:inline-block;'>Loading...</p>");
    document.styleSheets[0].addRule("p#second-onload-loading-element","{behavior: expression(DECORATOR.onAllBindingsAttached(this));}");
}

InsertElementForOnloadXBL = UX.isFF ? FFInsertElementForOnloadXBL : UX.isIE ? IEInsertElementForOnloadXBL :function(){};
