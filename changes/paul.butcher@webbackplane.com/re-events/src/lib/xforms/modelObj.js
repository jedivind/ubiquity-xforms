...
Model.prototype.onDocumentReady = function() {
    ...
    FormsProcessor.addDefaultEventListenerFor(this.element, this, "reset", "xforms-reset");

    FormsProcessor.addDefaultEventListenerFor(this.element, this, "_rebuild", "xforms-rebuild");
    FormsProcessor.addDefaultEventListenerFor(this.element, this, "_recalculate", "xforms-recalculate");
    FormsProcessor.addDefaultEventListenerFor(this.element, this, "_revalidate", "xforms-revalidate");
    FormsProcessor.addDefaultEventListenerFor(this.element, this, "_refresh", "xforms-refresh");
...
Model.prototype.refresh = function() {
  UX.dispatchEvent(this.element, "xforms-refresh", true, true, true);
};
