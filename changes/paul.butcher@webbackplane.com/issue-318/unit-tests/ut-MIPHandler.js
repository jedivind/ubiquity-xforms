...
(function(){
	...
	YAHOO.tool.TestRunner.add(new YAHOO.tool.TestCase({
		...
		testIsDirtyMIP : function () {
			...
			YAHOO.util.Assert.areSame(true, MIPTester.isDirtyMIP(this.testDiv,"readonly"));
		},

		testIsNotDirtyMIP : function () {
			this.testDiv.m_proxy = { m_oNode: {}, getMIPState: function () { return true; } };
			this.testDiv.m_MIPSCurrentlyShowing.readonly = true;
			YAHOO.util.Assert.areSame(false, MIPTester.isDirtyMIP(this.testDiv,"readonly"));
		},
		...
		testTestMIPChangesNoChange : function () {
			...
			MIPTester.testMIPChanges(this.testDiv);
