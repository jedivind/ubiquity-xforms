...
XFormsSelect.prototype.onValueSelected = function (value) {
	...
	if (value && typeof value === "object") {
		...
		value.valueInInstance = this.element.m_proxy.appendChild(value, this);
...
XFormsSelect.prototype.onValueDeselected = function (value) {
	var oEvt
	if (value && typeof value === "object") {
...
XFormsSelect.prototype.handleEvent = function (oEvt) {
	...
	case "fp-deselect":
		this.onValueDeselected(oEvt.target.getValue());
		break;
