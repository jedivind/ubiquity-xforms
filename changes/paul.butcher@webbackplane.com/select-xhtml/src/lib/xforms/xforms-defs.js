...
DECORATOR.addDecorationRules({
    ...
    "rules" : {
        ...
        "copy" : [
        {
            "name" : "copy-element",
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([EventTarget, MIPHandler, Context, Control, OptionalBinding, Copy]);
            }
        }
        ],
...
/*
    ...
    */
	...
	//Common child elements
		...
		{
			selector:"xf|select > xf|item, xf|select > xf|item *, xf|select > xf|itemset,  xf|select > xf|itemset * , xf|select > xf|choices, xf|select > xf|choices *",
			cssText:"-moz-binding:url();"
		},				
		
		{
			selector:"xf|select1 > xf|item, xf|select1 > xf|item *, xf|select1 > xf|itemset,  xf|select > xf|itemset * , xf|select > xf|choices, xf|select > xf|choices *",
			cssText:"-moz-binding:url();"
		},
