...
Instance.prototype.insertNodes = function (oContext, nodesetExpr, atExpr, position, originExpr) {
	return this.insertNodeset(((nodesetExpr) ? this.evalXPath(nodesetExpr, oContext).nodeSetValue() : null), oContext, atExpr, position, originExpr);
};

Instance.prototype.insertNodeset = function (ns, oContext, atExpr, position, originExpr) {
