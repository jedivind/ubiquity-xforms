...
XFormsProcessor.prototype.canSubmitByNavigation = function () {
	//Sadly, Selenium can't (as yet) cope with navigation oriented submissions
	//	Force otherwise "navigatey" submissions to work in the same way as non-navigatey ones.
	return (window.top.Selenium && window.top.Selenium.version !== "0.8.2");
};
