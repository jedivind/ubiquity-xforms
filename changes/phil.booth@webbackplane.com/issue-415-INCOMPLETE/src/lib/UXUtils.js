...
UX.areAltAndShiftModifiersExclusivelyPressed = function (keyEvent) {
	return UX.isAltKeyPressed(keyEvent) && UX.isShiftKeyPressed(keyEvent) && !UX.isControlKeyPressed(keyEvent) && !UX.isMetaKeyPressed(keyEvent);
};
