...
submission.prototype.submit = function(oSubmission) {
	...
	case "get":
		...
		oBody = this.serializeSubmitDataList(submitDataList, sSerialization, cdataSectionElements);
		break;
...
submission.prototype.serializeSubmitDataList = function(submitDataList, serializationFormat, cdataSectionElements) {
	var serialization = "";
	var xmlDoc = this.constructSubmitDataListDOM(submitDataList);
	
	if (serializationFormat === "application/xml") {
		serialization = xmlText(xmlDoc, cdataSectionElements);
