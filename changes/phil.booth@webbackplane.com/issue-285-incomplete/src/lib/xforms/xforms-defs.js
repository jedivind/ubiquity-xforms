...
DECORATOR.addDecorationRules({
    ...
    "rules" : {
        ...
        "submit" : [
        {
            "name" : "submit-element",
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([EventTarget, Context, Control, OptionalBinding, Submit]);
            }
        }
        ],
        ...
        "trigger" : [
        {
            ...
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([EventTarget, Context, Control, OptionalBinding]);
            }
        }
        ],
        ...
        "value" : [
        {
            "name" : "value-element",
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([EventTarget, Context, Control, OptionalBinding, Value]);
            }
        }
        ],
        ...
        "message" : [
        {
            ...
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([Listener, EventTarget, Context, Control, OptionalBinding, Message]);
            }
        }
        ],
