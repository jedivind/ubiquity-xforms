...
NavigableControlList.prototype.isEnabledControl = function (control) {
	return typeof control.isEnabled !== 'function' || control.isEnabled();
};
...
NavigableControlList.prototype.getNextControlAtSameIndex = function (control) {
	...
	for (var i = 0; i < this.list[control.navIndex].length; ++i) {
		...
		foundControl = UX.areSame(control, this.list[control.navIndex][i]);
	}
...
NavigableControlList.prototype.getFirstControlAtIndex = function (index) {
	return this.hasListItem(index) ? this.list[index][0] : null;
};

NavigableControlList.prototype.getLastControlAtIndex = function (index) {
	return this.hasListItem(index) ? this.list[index][this.list[index].length - 1] : null;
};

NavigableControlList.prototype.control = function (index) {
	return this.hasListItem(index) ? this.list[index][this.list[index].length - 1] : null;
};
