...
XFormsProcessor.prototype.listenForKeyDownEvent = function () {
	UX.listenForHTMLKeyDownEvent(this, document);
};
...
XFormsProcessor.prototype.navigateToFirstControl = function (control) {
	this.focusControl(this.navigationList.getFirstControl());
};

XFormsProcessor.prototype.navigateToLastControl = function (control) {
