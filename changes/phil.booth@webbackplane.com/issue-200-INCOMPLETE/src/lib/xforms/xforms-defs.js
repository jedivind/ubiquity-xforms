...
DECORATOR.addDecorationRules({
    ...
    "rules" : {
        ...
        },
        {
            "name" : "upload-pevalue",
            "match" : function(element) {
                return NamespaceManager.compareFullName(element.parentNode,"upload","http://www.w3.org/2002/xforms");
            },
            "apply" : function(arrBehaviours) {
                return arrBehaviours.concat([EventTarget, UploadValue]);
            }
        },
