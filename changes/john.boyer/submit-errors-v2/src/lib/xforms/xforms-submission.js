...
submission.prototype.submit = function(oSubmission) {
    ...
    var relevancePruning = Boolean(oSubmission.getAttribute("relevant") || String(sSerialisation !== "none"));
    var validation = Boolean(oSubmission.getAttribute("validate") || String(sSerialisation !== "none"));
    var submitDataList = [ ];
