...
Label.prototype.onContentReady = LoadExternal.prototype.initialise;

Label.prototype.dispatchException = LoadExternal.prototype.dispatchException;

Label.prototype.load = function(labelURL){
...
Label.prototype.parseInstance = function(){};

Label.prototype.finishLoad = function(){
	return false;
};
