...
var caseRepeatID = new YAHOO.tool.TestCase({
  ...
  tearDown: function(){
	...
	function() {
		...
		///Now assert that the id is some value.....
		Assert.areSame(this.repeat.childNodes[1].childNodes[0].getAttribute("id"),"in2");
		Assert.areSame(this.repeat.childNodes[1].childNodes[1].getAttribute("case"),"in");
		
		Assert.areSame(this.repeat.childNodes[2].childNodes[0].getAttribute("id"),"in3");
		Assert.areSame(this.repeat.childNodes[2].childNodes[1].getAttribute("case"),"in");
	},
