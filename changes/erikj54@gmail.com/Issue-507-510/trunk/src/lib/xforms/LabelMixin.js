...
function LabelMixin(element) {
	this.element = element;
	this.m_oDOM = null;
	this.m_sValue = null;
};

LabelMixin.prototype.load = function(labelURL){
...
LabelMixin.prototype.parseInstance = function(){};

LabelMixin.prototype.finishLoad = function(){
	return false;
};
