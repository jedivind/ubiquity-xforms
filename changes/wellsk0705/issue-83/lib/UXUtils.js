...
/**
	Utility for IE contains function.
*/
   UX.contains = function (oElement, isDescendentElement) {
      /*
       * compareDocumentPosition is a bitwise DOM Level 3 API to determine location of two elements to each other
       * the 010000 === 16 bitwise argument indicates containment
       */
      return oElement.contains ? oElement !== isDescendentElement && oElement.contains(isDescendentElement) : !!(oElement.compareDocumentPosition(isDescendentElement) & 16);
