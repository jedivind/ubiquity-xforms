...
function Repeat(elmnt) {
    ...
    Repeat.prototype.storeTemplate = function() {
        if (this.sTemplate === undefined || this.sTemplate === null) {
            this.sTemplate = (UX.isXHTML) ? document.createElementNS("http://www.w3.org/2002/xforms","sTemplate") :
                                            document.createElement("sTemplate");
            while(this.element.childNodes.length) {
                if (this.element.firstChild.nodeType === 1) {
                    this.sTemplate.appendChild(this.element.firstChild);
                } 
                else {
