...
DECORATOR.addDecorationRules({
    ...
    "rules" : {
        ...
        },
        {
            ...
            "apply" : function(arrBehaviours) {
                UX.replaceArrayElement(arrBehaviours,XFormsOutputValue,XFormsOutputValueCurrency);
                return arrBehaviours;
            }
        },
        {
...
UX.selectors = {
    ...
    output : {
        currency : "xf|output.currency > pe-value"     
    }      
};
...
if (!UX.isIE6) {
    ...
    UX.selectors.output.currency += ", xf|output[appearance='currency'] > pe-value";
}
...
/*
    ...
    */
        ...
        // currency on xf:output
        {
            selector: UX.selectors.output.currency,
            objects:[]
        },
