...
(
  function(){
    ...
    loader.addModule({ name: "xforms-output-currency",        type: "js",  fullpath: moduleBase + "../extensions/output-currency.js" });
    ...
    loader.addModule({ name: "xforms-defs",                type: "js",  fullpath: moduleBase + "xforms-defs.js",
      requires: [
        ...
        "xforms-input-value", "xforms-output-value", "xforms-range-value", "xforms-output-currency", 
