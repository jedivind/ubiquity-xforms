...
submission.prototype.setSOAPHeaders = function(soapVersion, sMediatype, sSoapAction, sCharset) {
    throw "submission::setSOAPHeaders() has not been implemented";
}
...
submission.prototype.submit = function(oSubmission) {
    ...
    case "post":
        ...
        //
        this.buildSoapHeaders(oContext.node, sMediatype, sEncoding); 
...
submission.prototype.buildSoapHeaders = function(oContextNode, sMediatype, sEncoding) {
    var result;
    ...
    if (sMediatype) {
        ...
        this.setSOAPHeaders(soapVersion, sMediatype, sSOAPAction, sCharset);                       
    }
}