...
callback.prototype.processResponse = function(oResponse, isFailure)
{
	return this.m_mediator.processResponse(oResponse, isFailure);
}
...
/*
 * The comms library being used must override these methods.
 */
...
{
	throw "callback::processResponse() has not been implemented";
}

submission.prototype.processResult = function(sData, isFailure, oObserver, oContext)
{
    var oEvt, oNewDom, sReplace;
	...
	if (oObserver)
	{
        ...
        if (isFailure)
        {
            ...
            oEvt.context = this.m_contextInfo;
...
submission.prototype.submit = function(oSubmission)
{
    ...
    try {
       ...
       this.submissionBody = document.createTextNode("");
       oEvt.context = { "submission-body" : this.m_submissionBody };
       FormsProcessor.dispatchEvent(oSubmission,oEvt);

       if (this.m_submissionBody.value) {
           sBody = this.m_submissionBody;
       }
    } catch(e) {
