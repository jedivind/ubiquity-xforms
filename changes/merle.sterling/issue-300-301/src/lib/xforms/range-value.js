...
RangeValue.prototype.isTypeAllowed = function (sType) {
  ...
  if (sType === "xsd:duration" || sType === "xsd:date" ||
      sType === "xsd:time" || sType === "xsd:dateTime" ||
      sType === "xsd:gYearMonth" || sType === "xsd:gYear" ||
      sType === "xsd:gMonthDay" || sType === "xsd:gDay" ||
      sType === "xsd:gMonth" || sType === "xsd:float" ||
      sType === "xsd:double" || sType === "xsd:decimal") {
      return true;
  }
  return false;
};
