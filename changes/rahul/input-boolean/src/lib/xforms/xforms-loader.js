...
//						 fullpath: "http://ubiquity-backplane.googlecode.com/svn/tags/0.4.9/backplane-loader.js",
    ...
    loader.addModule({ name: "xpath-extension-sha",        type: "js",  fullpath: moduleBase + "../third-party/jsSHA/src/sha.js" });
  	...
  	loader.addModule({ name: "xforms-boolean-value",       type: "js",  fullpath: moduleBase + "boolean-value.js" });
   ...
   loader.addModule({ name: "xforms-insert",               type: "js",  fullpath: moduleBase + "insert.js",
    ...
    loader.addModule({ name: "xforms-defs",                type: "js",  fullpath: moduleBase + "xforms-defs.js",
      requires: [
        ...
        "xforms-pe-value", "xforms-boolean-value", "xforms-input-value", "xforms-output-value", "xforms-range-value", 
