...
*/	
	...
	var xFormsDecorationRules = {
		...
		"model" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Model"]);
				return arrBehaviours;
			}
		}
		],
		...
		"instance" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Instance"]);
				return arrBehaviours;
			}
		}
		],
		...
		"submission" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "Submission"]);
				return arrBehaviours;
			}
		}
		],
		...
		"submit" : [
		{
			"name" : "submit-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "Control", "Submit"]);
				return arrBehaviours;
			}
		}
		],
		...
		"trigger" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "Control"]);
				return arrBehaviours;
			}
		}
		],
		...
		"select" : [
		{
			"name" : "select-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "Control", "Select"]);
				return arrBehaviours;
			}
		}
		],
		...
		"select1" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "Control", "XFormsSelect1", "FiniteControl"]);
				return arrBehaviours;
			}
		}
		],
		...
		"item" : [
		{
			"name" : "item-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "Item"]);
				return arrBehaviours;
			}
		}
		],
		...
		"value" : [
		{
			"name" : "value-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "Control", "Value"]);
				return arrBehaviours;
			}
		}
		],
		...
		"group" : [
		{
			"name" : "group-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "Group"]);
				return arrBehaviours;
			}
		}
		],
		...
		"switch" : [
		{
			"name" : "switch-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "Switch"]);
				return arrBehaviours;
			}
		}
		],
		...
		"case" : [
		{
			"name" : "case-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "XFormsCase"]);
				return arrBehaviours;
			}
		}
		],
		...
		"repeat" : [
		{
			"name" : "repeat-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "Context", "Repeat"]);
				return arrBehaviours;
			}
		}
		],
		...
		"action" : [
		{
			"name" : "action-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["Listener", "XFAction"]);
				return arrBehaviours;
			}
		}
		],
		...
		"message" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["Listener", "Message"]);
				return arrBehaviours;
			}
		}
		],
		...
		"setvalue" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["Listener", "Context", "SetValue"]);
				return arrBehaviours;
			}
		}
		],
		...
		"send" : [
		{
			"name" : "send-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["Listener", "Send"]);
				return arrBehaviours;
			}
		}
		],
		...
		"toggle" : [
		{
			"name" : "toggle-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["Listener", "Toggle"]);
				return arrBehaviours;
			}
		}
		],
		...
		"rebuild" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["Listener", "Rebuild"]);
				return arrBehaviours;
			}
		}
		],
		...
		"recalculate" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["Listener", "Recalculate"]);
				return arrBehaviours;
			}
		}
		],
		...
		"revalidate" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["Listener", "Revalidate"]);
				return arrBehaviours;
			}
		}
		],
		...
		"refresh" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["Listener", "Refresh"]);
				return arrBehaviours;
			}
		}
		],
		...
		"reset" : [
		{
			"name" : "reset-element",
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["Listener", "Reset"]);
				return arrBehaviours;
			}
		}
		],
		...
		"pe-value" : [
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget"]);
				return arrBehaviours;
			}
		},
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "XFormsOutputValue"]);
				return arrBehaviours;
			}
		},
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "XFormsInputValue"]);
				return arrBehaviours;
			}
		},
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "XFormsSelectValue"]);
				return arrBehaviours;
			}
		},
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "XFormsSelect1Value"]);
				return arrBehaviours;
			}
		},
		{
			...
			"apply" : function(arrBehaviours) {
				arrBehaviours = arrBehaviours.concat(["EventTarget", "RangeValue"]);
				return arrBehaviours;
			}
		},
		// custom control pe-values below
		{
			...
			"apply" : function(arrBehaviours) {
				replaceArrayElement(arrBehaviours,"XFormsInputValue","InputValueCalendar");
				return arrBehaviours;
			}
		},
		{
			...
			"apply" : function(arrBehaviours) {
				replaceArrayElement(arrBehaviours,"XFormsInputValue","InputValueColor");
				return arrBehaviours;
			}
		},
		{
			...
			"apply" : function(arrBehaviours) {
				replaceArrayElement(arrBehaviours,"RangeValue","RangeValueGMAP");
				return arrBehaviours;
			}
		}
		],
	...
	function updateDecorationObjectNames(element,arrBehaviours)
	{
		...
		if (elementNSURI === "http://www.w3.org/2002/xforms" || elementLocalName === "pe-value") {
			rules = xFormsDecorationRules[elementLocalName].concat(xFormsDecorationRules["*"]);
		}
		// so on for other namespaces
	...
	function replaceArrayElement(array,remove,add) {
		var counter;
