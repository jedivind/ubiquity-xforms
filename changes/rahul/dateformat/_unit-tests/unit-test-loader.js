...
function runTheTests() {
  ...
  loader.addModule({ name: "ux-ut-input-calendar", type: "js",  fullpath: moduleBase + "ut-input-calendar.js" });
  ...
  loader.onSuccess = function(o) {
    ...
    // NOTE: Some of the suites add themselves so this is not a complete list
