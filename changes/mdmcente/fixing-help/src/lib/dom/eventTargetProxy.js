...
var EventTarget = null;
		...
		function dispatchXformsHelp(elmnt, e) {
			var oEvt = elmnt.ownerDocument.createEvent("UIEvents");

			oEvt.initUIEvent("xforms-help", true, true, null, 1);
...
else
{
    ...
    //
		...
		this.element.addEventListener("dblclick",  function( evt ){ dispatchXformsHelp(elmnt, evt); },false);
		this.element.addEventListener("keydown",   function( evt ){ if (evt.keyCode === 112) { dispatchXformsHelp(elmnt, evt); } },false);
