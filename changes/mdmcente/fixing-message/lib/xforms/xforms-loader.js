...
(
  function(){
    ...
    loader.addModule({ name: "yui-style-css",       type: "css", fullpath: moduleBase + "../_platform/yui/yui-style.css" });
    loader.addModule({ name: "xforms-notify",       type: "js",  fullpath: moduleBase + "../_backplane/notify.js" });
    loader.addModule({ name: "message-yui",  type: "js",  fullpath: moduleBase + "../_platform/yui/message-yui.js" });
