...
Model.prototype.getInstanceDocument = function(sID) {
    ...
    if (sID && sID !== "") {
        ...
        if (oInstance && oInstance.parentNode != this.element) {
            throw "instance '" + sID + 
                  "' is not part of model '" + this.element.id + "'";
        } else {
        ...
        oInstance = NamespaceManager.getElementsByTagNameNS(
                        this.element, 
...
// remove function getElementsByTagNameNS(el,prefix,tn)
...
Model.prototype.revalidate = function() {
    this.m_bNeedRevalidate = false;
    //TODO: There is no validation in AJAXSLT DOM, this needs to be implemented. 
...
Model.prototype.createMIP = function(oVertex, sMIPName, 
                                     sExpr,   oPN,  
                                     oContextNode) {
