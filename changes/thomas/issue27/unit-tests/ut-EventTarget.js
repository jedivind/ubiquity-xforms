...
var oEventTargetListenerTest = new YAHOO.tool.TestCase({
    ...
    setUp       :   function() {
        var elements = NamespaceManager.getElementsByTagNameNS(document.body, "http://www.w3.org/2002/xforms", "instance");
