...
(
  function(){
	...
	loader.addModule({ name: "ubiquity-type",              type:"js", fullpath: moduleBase + "../type.js" });
	loader.addModule({ name: "ubiquity-collection",       type: "js", fullpath: moduleBase + "../collection.js",
        requires: [ "ubiquity-type" ] });
    ...
    loader.addModule({ name: "xpath-extension-sha1",        type: "js",  fullpath: moduleBase + "../third-party/sha1.js" });
  	...
  	loader.addModule({ name: "xforms-ajaxslt-improvements", type: "js",  fullpath: moduleBase + "ajaxslt-improvements.js",
  					   requires: [ "xforms-dom", "xforms-xpath", "ubiquity-collection", "ubiquity-type" ] });
