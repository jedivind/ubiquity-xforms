...
submission.prototype.submit = function(oSubmission) {
    ...
    var bOmitXmlDeclaration = UX.fromXsdBoolean(oSubmission.getAttribute("omit-xml-declaration"), false);
    var sStandalone = UX.fromXsdBoolean(oSubmission.getAttribute("standalone"));
