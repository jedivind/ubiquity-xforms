...
(
  function(){
    var moduleBase = pathToModule("xforms-loader-yui");
  	...
  	loader.addModule({ name: "xforms-message-core-yui", type: "js",  fullpath: moduleBase + "xforms-message-yui.js" });

    loader.require( "xforms-submission-core-yui", "xforms-message-core-yui" );
  }()
);
