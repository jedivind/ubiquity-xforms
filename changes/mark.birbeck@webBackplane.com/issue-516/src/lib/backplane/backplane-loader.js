 ...
 * ../xforms/xforms-loader.js. They can be safely removed, and this module
 * reinistated, when the rollup builder for ubiquity-xforms is capable of
 * traversing nested loaders.
 */
 /*(
	function() {
