...
Hint.prototype.performAction = function(oEvt)
{
    if (oEvt.type === "xforms-hint") {
    	...
    	// It looks like hints do not work on IE yet, but when the xf:alert code is added later,
    	// then the hints should work on IE.
    	
    	// When the xf:alert code is added later, you only need this code to make hints work on Firefox and IE:
    	// var hintSTR = this.element.m_sValue;
    	
    	// But for now you need this code for xf:hint to work correctly on Firefox:
