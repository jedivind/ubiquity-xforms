...
var g_bIsInXHTMLMode = !document.write; // needs moving to UX.modeXHTML or some such
    ...
    **/
    ...
    function applyDecorationRules(doc)
    {
        var currentDocument = doc || document,
            ...
            count;
        if (UX.isIE || UX.isFF)
        { // quit if there is a better mechanism, HTC or XBL respectively
            return;
        }
...
*/	
   ...
   /*     try{
     ...
     */ }
    		...
    		//WK support: Causes a NO_MODIFICATION_ALLOWED_ERR in WebKit
    		//oStyle.innerHTML = s;
...
*/	
	...
	function getDecorationObjectNames(element)
	{
		var sBehaviours = getCustomCSSProperty(element,"-moz-binding"),
		    arrBehaviours = [];
		//WK support: sBehaviours can be null
