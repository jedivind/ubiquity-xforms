...
SetValue.prototype.handleEvent = DeferToConditionalInvocationProcessor;
		...
		SetValue.prototype.performAction = function(evt)
		{
			...
			/*
			 * Work out where to put the calculated value.
			 */
			...
			/*
			 * Calculate the value. Note that the context for
			 * evaluation is the node that we are going to
			 * store into.
			 */
			...
			/*
			 * Update the node. Passing a model value indicates that
			 * we want a recalculate, etc.
			 */
