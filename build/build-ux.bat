...
cscriptk %~dp0rollup\make-rollup.wsf %compress-arg% /js:%~dp0..\package\ubiquity-xforms.js /css:%~dp0..\src\assets\ubiquity-xforms.css /paths:xforms-loader:file:///%~dp0../src/lib/xforms/ < %~dp0..\src\lib\xforms\xforms-loader.js
