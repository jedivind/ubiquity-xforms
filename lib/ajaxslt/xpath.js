...
function makeLocationExpr8(fc,slash,rel)
{
  rel.prependStep(fc);
  return rel;
}
...
var TOK_NCNAME = { label: "[ncname]", re: new RegExp('^[_a-z][-\\w]*','i') };
...
var xpathGrammarRules =
  [
   ...
   [ XPathRelativeLocationPath,
     [ XPathFunctionCall, TOK_SLASH, XPathRelativeLocationPath ], 3,
     makeLocationExpr8 ],
