...
XFormsProcessor.prototype.invokeListener = function(oListener, oEvt)
{
	//This is likely to hgave been called with a proxy listener, as defined in ConditionalInvocationListener
	...
	if(typeof(oRealListener.getEvaluationContext) != "undefined")
	{
		...
		else if (evaluateIfCondition(oRealListener,oContext))
		{
			...
			if(oRealListener.getAttribute("while"))
			{
				var oContext = oRealListener.getBoundNode(1);
