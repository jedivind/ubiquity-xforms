...
// JScript source code
	...
	function setState(pThis,oProxy, sMIPName, sOn, sOff)
	{
		...
		//	 is one of the more time-consuming actions in IE.  So doing it (6 * 4) times 
		//	 ( == calls in this function * calls to this function)
		//	 on every single control on every single refresh is hardly sensible when we are trying to 
		//	 produce a more performant version of the AJAX form.  
